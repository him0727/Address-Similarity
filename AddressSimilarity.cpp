...
AddressSimilarity :: AddressSimilarity(float ccsw, float ccmw, int ct, float ecsw, float ecmw, int et) {
  chs_cos_weight = ccsw;
  chs_com_weight = ccmw;
...
float AddressSimilarity :: compare_eng_addr(string raw_addr1, string raw_addr2) {
...
void AddressSimilarity :: set_params(float ccsw, float ccmw, int ct, float ecsw, float ecmw, int et) {
  chs_cos_weight = ccsw;
  chs_com_weight = ccmw;
  chs_threshold = ct ? ct : 1;
  eng_cos_weight = ecsw;
